<template>
  <div :class="['container', { 'show-segments': showSegments }]">
    <h1>
      BudouX Vue Example
    ...
    <div class="example-section">
      ...
      <div class="demo-box narrow">
        <div v-for="(phrase, index) in phrases" :key="index" class="large-text">
          <BudouX :text="phrase" />
        </div>
      </div>
    </div>
    ...
    <div class="example-section">
      <h2>特大フォントでの表示</h2>
      <div class="demo-box medium">
        <div v-for="(phrase, index) in phrases.slice(0, 3)" :key="index" class="extra-large-text">
          <BudouX :text="phrase" />
        </div>
      </div>
    </div>
    ...
    <div class="example-section">
      ...
      <div class="demo-box medium">
        <div class="large-text">
          <BudouX text="カスタムクラス名を使用した例です。" :class-name="'custom-no-wrap'" />
        </div>
      </div>
    </div>
  </div>
...
<script>
import { ref } from 'vue';
import BudouX from '../../dist/vue/vue/index.js';
